...
// Metadata.
const NAME = "Arshtyi";
const EMAIL = "arshtyi@foxmail.com";
const YEAR = new Date().getFullYear();
const TITLE = "Arshtyi's Blog";
const DESCRIPTION = "Blog about my research and development.";
const BASE_URL = "https://arshtyi.github.io";
...
function build() {
    ...
    // Setups output directory, copy style file.
    mkdir("dist");
...
function GitHub() {
    return (
        <a href="https://github.com/arshtyi" className="social">
